...
from network_visualizer.models import Papers, Works, Authors, AuthorTopics, Citations, Topfives



pkl_file = open('DAC-Graph-Library/ranked_similar_papers.pkl', 'rb')
ranked_array = pickle.load(pkl_file)
pkl_file.close()

index = 2
#971
for i in range(951, len(ranked_array)):
	index += 1
	print "i: ", i
	...
	for j in range(len(top_10)):
		# print i, j
		r1 = Topfives.objects.create( parentid = p_id, childid = top_10[j], rank = j+1)
		# r1.save()
